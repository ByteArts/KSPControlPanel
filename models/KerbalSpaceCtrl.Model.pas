...
type
  ...
  TKerbalSpaceControl = class
    ...
    public
      ...
      function DoControl(const AControl: TKSPControlEntry): boolean;
...
function TKerbalSpaceControl.DoControl(const AControl: TKSPControlEntry): boolean;
var
...
begin
  ...
  cteControl := KSPCONTROL_TABLE[AControl.CtrlID];

  case AControl.CtrlID of
    kcStaging:
    begin
      msgCall.Initialize;
...
function TKerbalSpaceControl.GetLastConnectionError: string;
begin
  Result := FSocketMgr.LastError;
end;
